...
$en = array(
	...
	'new:feed' => 'Tin tức',
	'photos:ossn' => 'Ảnh',
	'admin:view:site' => 'Xem trang web',
	
	'home:top:heading' => "Chào mừng bạn đến với %s! Tham gia ngay bây giờ để kết bạn mới, tạo nhóm, thêm ảnh và nhiều hơn nữa.",
	'create:account' => 'Tạo tài khoản',
	'its:free' => "Nó miễn phí và sẽ mãi như thế.",
	
	'register:ok:message' => "Tài khoản của bạn đã được đăng ký. Một email kích hoạt đã được gửi đến hộp thư của bạn. Nếu bạn không nhận được email, vui lòng kiểm tra thư mục thư rác / thư rác.",
	...
	'male' => 'Nam',
	'female' => 'Nữ',
	'account:create:notice' => 'Bằng cách nhấp vào Tạo tài khoản, bạn đồng ý với chúng tôi',
	'gender' => 'Giới tính',
	
	'account:settings' => 'Cài đặt tài khoảng',
	'page:error' => 'Không tìm thấy trang!',
	'page:error:text' => 'Trang bạn yêu cầu không có sẵn hoặc có thể đã bị xóa.',
	'page:error:heading' => '404',
	
	'search:users' => 'Mọi người',
	'admin:logout' => 'Đăng xuất',
	'logout' => 'Đăng xuất',
	
	'admin:components' => 'Các thành phần',
	'admin:dashboard' => 'Bảng điều khiển',
	'admin:install' => 'Trình cài đặt',
	'admin:themes' => 'Giao diện',
	'admin:basic' => 'Cơ bản',
	'admin:cache' => 'Bộ nhớ cache',
	'admin:mode' => 'Chế độ',
	'configure' => 'Cấu hình',
	'admin:help' => 'Trợ giúp',
	...
	'admin:user:deleted' => 'Người dùng đã bị xóa!',
	'admin:user:delete:error' => 'Không thể xóa người dùng. Vui lòng thử lại sau.',
	...
	'my:version' => 'Phiên bản OSSN của tôi',
	'online:users' => 'Người dùng hoạt động',
	'themes' => 'Chủ đề',
	'users' => 'Người dùng',
